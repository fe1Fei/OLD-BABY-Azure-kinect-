...
import sys
sys.path.append(r'F:\zsw_room\FDU_TUK\myfile\EmbeddedSystem\code\MPPE-master')
...
class Updater(StandardUpdater):
    ...
    def update_core(self):
        ...
        print('**********train_iter.next',batch)#,isinstance(train_iter, Iterable))
...
if __name__ == '__main__':
    ...
    train_iter = chainer.iterators.MultithreadIterator(train_loader, args.batchsize, n_threads=args.loaderjob)
    val_iter = chainer.iterators.MultithreadIterator(val_loader, args.valbatchsize, n_threads=args.loaderjob, repeat=False, shuffle=False)
